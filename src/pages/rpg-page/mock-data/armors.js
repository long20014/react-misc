...
export function armorBuilder(armor) {
  const defense = utilService.getRandomInt(armor.defense.min, armor.defense.max);
...
export function refineArmor(armor, armorPrototype, option) {
